...
pub fn run() {
  tauri::Builder::default()
    ...
    .invoke_handler(tauri::generate_handler![
      ...
      commands::dosage::get_configured_dosage_drugs,
      commands::dosage::assess_patient_dosage,
      ...
      commands::settings::save_dosage_rules,
      commands::settings::get_regimen_definitions,
      commands::settings::load_dosage_rules,
